...
//
//     final tvTopRatedResponse = tvTopRatedResponseFromMap(jsonString);

import 'dart:convert';

import '../../../domain/entity/tv_series_entity.dart';

TvTopRatedResponse tvTopRatedResponseFromMap(String str) => TvTopRatedResponse.fromMap(json.decode(str));

String tvTopRatedResponseToMap(TvTopRatedResponse data) => json.encode(data.toMap());

class TvTopRatedResponse {
  int? page;
  List<Result>? results;
  int? totalPages;
  int? totalResults;
  ...
  factory TvTopRatedResponse.fromMap(Map<String, dynamic> json) => TvTopRatedResponse(
    page: json["page"],
  ...
  //TvTopRatedResponse to List<TvSeriesEntity>
  static List<TvSeriesEntity> fromMapToTvSeriesEntity(Map<String, dynamic> map) {
    return (map['results'] as List)
        .map((data) => TvSeriesEntity.fromMap(data))
        .toList();
  }
